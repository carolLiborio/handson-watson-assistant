...
k.indexOf("<");return{length:0<=q?q:k.length}}},t=function(){for(var q in p)if(p[q].test(k)){var u=r[q]();return u?(u.type=u.type||q,u.text=k.substr(0,u.length),k=k.slice(u.length),u):null}};l.ue&&function(){var q=/^(AREA|BASE|BASEFONT|BR|COL|FRAME|HR|IMG|INPUT|ISINDEX|LINK|META|PARAM|EMBED)$/i,u=/^(COLGROUP|DD|DT|LI|OPTIONS|P|TD|TFOOT|TH|THEAD|TR)$/i,w=[];w.De=function(){return this[this.length-1]};w.ad=function(z){var D=this.De();return D&&D.tagName&&D.tagName.toUpperCase()===z.toUpperCase()};w.hg=
function(z){for(var D=0,H;H=this[D];D++)if(H.tagName===z)return!0;return!1};var v=function(z){z&&"startTag"===z.type&&(z.Db=q.test(z.tagName)||z.Db);return z},y=t,x=function(){k="</"+w.pop().tagName+">"+k},A={startTag:function(z){var D=z.tagName;"TR"===D.toUpperCase()&&w.ad("TABLE")?(k="<TBODY>"+k,B()):l.Ph&&u.test(D)&&w.hg(D)?w.ad(D)?x():(k="</"+z.tagName+">"+k,B()):z.Db||w.push(z)},endTag:function(z){w.De()?l.ug&&!w.ad(z.tagName)?x():w.pop():l.ug&&(y(),B())}},B=function(){var z=k,D=v(y());k=z;if(D&&
A[D.type])A[D.type](D)};t=function(){B();return v(y())}}();return{append:function(q){k+=q},gh:t,Vh:function(q){for(var u;(u=t())&&(!q[u.type]||!1!==q[u.type](u)););},clear:function(){var q=k;k="";return q},Wh:function(){return k},stack:[]}}var b=function(){var k={},l=this.document.createElement("div");l.innerHTML="<P><I></P></I>";k.$h="<P><I></P></I>"!==l.innerHTML;l.innerHTML="<P><i><P></P></i></P>";k.Zh=2===l.childNodes.length;return k}(),c=/^<([\-A-Za-z0-9_]+)((?:\s+[\w\-]+(?:\s*=?\s*(?:(?:"[^"]*")|(?:'[^']*')|[^>\s]+))?)*)\s*(\/?)>/,
...
t){d(t,function(q,u){r[q]=u});return r}function f(r,t){r=r||{};d(t,function(q,u){b(r[q])||(r[q]=u)});return r}function h(r){try{return m.call(r)}catch(q){var t=[];c(r,function(u){t.push(u)});return t}}var k={Of:a,Pf:a,Qf:a,Rf:a,Yf:a,Zf:function(r){return r},done:a,error:function(r){throw r;},jh:!1},l=this;if(!l.postscribe){var m=Array.prototype.slice,p=function(){function r(q,u,w){var v="data-ps-"+u;if(2===arguments.length){var y=q.getAttribute(v);return b(y)?String(y):y}b(w)&&""!==w?q.setAttribute(v,
w):q.removeAttribute(v)}function t(q,u){var w=q.ownerDocument;e(this,{root:q,options:u,Eb:w.defaultView||w.parentWindow,Pa:w,ic:dc("",{Xf:!0}),Nc:[q],ld:"",md:w.createElement(q.nodeName),Ab:[],Fa:[]});r(this.md,"proxyof",0)}t.prototype.write=function(){[].push.apply(this.Fa,arguments);for(var q;!this.Sb&&this.Fa.length;)q=this.Fa.shift(),"function"===typeof q?this.dg(q):this.vd(q)};t.prototype.dg=function(q){var u={type:"function",value:q.name||q.toString()};this.gd(u);q.call(this.Eb,this.Pa);this.Je(u)};
t.prototype.vd=function(q){this.ic.append(q);for(var u,w=[],v,y;(u=this.ic.gh())&&!(v=u&&"tagName"in u?!!~u.tagName.toLowerCase().indexOf("script"):!1)&&!(y=u&&"tagName"in u?!!~u.tagName.toLowerCase().indexOf("style"):!1);)w.push(u);this.Ah(w);v&&this.Cg(u);y&&this.Dg(u)};t.prototype.Ah=function(q){var u=this.ag(q);u.ie&&(u.Xc=this.ld+u.ie,this.ld+=u.eh,this.md.innerHTML=u.Xc,this.xh())};t.prototype.ag=function(q){var u=this.Nc.length,w=[],v=[],y=[];c(q,function(x){w.push(x.text);if(x.S){if(!/^noscript$/i.test(x.tagName)){var A=
u++;v.push(x.text.replace(/(\/?>)/," data-ps-id="+A+" $1"));"ps-script"!==x.S.id&&"ps-style"!==x.S.id&&y.push("atomicTag"===x.type?"":"<"+x.tagName+" data-ps-proxyof="+A+(x.Db?" />":">"))}}else v.push(x.text),y.push("endTag"===x.type?x.text:"")});return{ai:q,raw:w.join(""),ie:v.join(""),eh:y.join("")}};t.prototype.xh=function(){for(var q,u=[this.md];b(q=u.shift());){var w=1===q.nodeType;if(!w||!r(q,"proxyof")){w&&(this.Nc[r(q,"id")]=q,r(q,"id",null));var v=q.parentNode&&r(q.parentNode,"proxyof");
v&&this.Nc[v].appendChild(q)}u.unshift.apply(u,h(q.childNodes))}};t.prototype.Cg=function(q){var u=this.ic.clear();u&&this.Fa.unshift(u);q.src=q.S.src||q.S.Hh;q.src&&this.Ab.length?this.Sb=q:this.gd(q);var w=this;this.zh(q,function(){w.Je(q)})};t.prototype.Dg=function(q){var u=this.ic.clear();u&&this.Fa.unshift(u);q.type=q.S.type||q.S.TYPE||"text/css";this.Bh(q);u&&this.write()};t.prototype.Bh=function(q){var u=this.cg(q);this.Gg(u);q.content&&(u.styleSheet&&!u.sheet?u.styleSheet.cssText=q.content:
u.appendChild(this.Pa.createTextNode(q.content)))};t.prototype.cg=function(q){var u=this.Pa.createElement(q.tagName);u.setAttribute("type",q.type);d(q.S,function(w,v){u.setAttribute(w,v)});return u};t.prototype.Gg=function(q){this.vd('<span id="ps-style"/>');var u=this.Pa.getElementById("ps-style");u.parentNode.replaceChild(q,u)};t.prototype.gd=function(q){q.Wg=this.Fa;this.Fa=[];this.Ab.unshift(q)};t.prototype.Je=function(q){q!==this.Ab[0]?this.options.error({message:"Bad script nesting or script finished twice"}):
(this.Ab.shift(),this.write.apply(this,q.Wg),!this.Ab.length&&this.Sb&&(this.gd(this.Sb),this.Sb=null))};t.prototype.zh=function(q,u){var w=this.bg(q),v=this.ph(w),y=this.options.Of;q.src&&(w.src=q.src,this.nh(w,v?y:function(){u();y()}));try{this.Fg(w),q.src&&!v||u()}catch(x){this.options.error(x),u()}};t.prototype.bg=function(q){var u=this.Pa.createElement(q.tagName);d(q.S,function(w,v){u.setAttribute(w,v)});q.content&&(u.text=q.content);return u};t.prototype.Fg=function(q){this.vd('<span id="ps-script"/>');
var u=this.Pa.getElementById("ps-script");u.parentNode.replaceChild(q,u)};t.prototype.nh=function(q,u){function w(){q=q.onload=q.onreadystatechange=q.onerror=null}var v=this.options.error;e(q,{onload:function(){w();u()},onreadystatechange:function(){/^(loaded|complete)$/.test(q.readyState)&&(w(),u())},onerror:function(){var y={message:"remote script failed "+q.src};w();v(y);u()}})};t.prototype.ph=function(q){return!/^script$/i.test(q.nodeName)||!!(this.options.jh&&q.src&&q.hasAttribute("async"))};
return t}();l.postscribe=function(){function r(){var v=u.shift(),y;v&&(y=v[v.length-1],y.Pf(),v.stream=t.apply(null,v),y.Qf())}function t(v,y,x){function A(H){H=x.Zf(H);w.write(H);x.Rf(H)}w=new p(v,x);w.id=q++;w.name=x.name||w.id;var B=v.ownerDocument,z={close:B.close,open:B.open,write:B.write,writeln:B.writeln};e(B,{close:a,open:a,write:function(){return A(h(arguments).join(""))},writeln:function(){return A(h(arguments).join("")+"\n")}});var D=w.Eb.onerror||a;w.Eb.onerror=function(H,M,N){x.error({Th:H+
" - "+M+":"+N});D.apply(w.Eb,arguments)};w.write(y,function(){e(B,z);w.Eb.onerror=D;x.done();w=null;r()});return w}var q=0,u=[],w=null;return e(function(v,y,x){"function"===typeof x&&(x={done:x});x=f(x,k);v=/^#/.test(v)?l.document.getElementById(v.substr(1)):v.Rh?v[0]:v;var A=[v,y,x];v.Zg={cancel:function(){A.stream?A.stream.abort():A[1]=a}};x.Yf(A);u.push(A);w||r();return v.Zg},{streams:{},Uh:u,Jh:p})}();ec=l.postscribe}})();var C={ab:"_ee",Lc:"_syn",Ih:"_uei",Ac:"event_callback",Jb:"event_timeout",I:"gtag.config",fa:"allow_ad_personalization_signals",Bc:"restricted_data_processing",Za:"allow_google_signals",ia:"cookie_expires",Ib:"cookie_update",$a:"session_duration",ka:"user_properties",va:"transport_url",N:"ads_data_redaction"};C.Ce=[C.fa,C.Za,C.Ib];C.Ge=[C.ia,C.Jb,C.$a];var E=window,F=document,fc=navigator,gc=F.currentScript&&F.currentScript.src,hc=function(a,b){var c=E[a];E[a]=void 0===c?b:c;return E[a]},ic=function(a,b){b&&(a.addEventListener?a.onload=b:a.onreadystatechange=function(){a.readyState in{loaded:1,complete:1}&&(a.onreadystatechange=null,b())})},jc=function(a,b,c){var d=F.createElement("script");d.type="text/javascript";d.async=!0;d.src=a;ic(d,b);c&&(d.onerror=c);var e;if(null===ka)b:{var f=ia.document,h=f.querySelector&&f.querySelector("script[nonce]");
...
return null},Xc=!1;if(F.querySelectorAll)try{var Yc=F.querySelectorAll(":root");Yc&&1==Yc.length&&Yc[0]==F.documentElement&&(Xc=!0)}catch(a){}var Uc=Xc;var ld={},md=null,od=Math.random();ld.s="GTM-564S72";ld.Ob="6a0";ld.Ld="";var pd={__cl:!0,__ecl:!0,__ehl:!0,__evl:!0,__fal:!0,__fil:!0,__fsl:!0,__hl:!0,__jel:!0,__lcl:!0,__sdl:!0,__tl:!0,__ytl:!0,__paused:!0,__tg:!0},qd="www.googletagmanager.com/gtm.js";
var rd=qd,sd=null,td=null,ud=null,vd="//www.googletagmanager.com/a?id="+ld.s+"&cv=87",wd={},xd={},yd=function(){var a=md.sequence||0;md.sequence=a+1;return a};
...
f(l)||c()}else c()},e=function(){K(b,d,c)};if(Jc()){Tc(function(){Qc(C.o)?e():Sc(e)},[C.o]);return}Tg();e()})}();W.a.c=["google"],function(){(function(a){W.__c=a;W.__c.b="c";W.__c.g=!0;W.__c.priorityOverride=0})(function(a){return a.vtp_value})}();
...
[];k.firstChild;)r.push(k.removeChild(k.firstChild));d.insertBefore(k,null);a(k,r,l,h)()}else d.insertBefore(k,null),l()}else f()}catch(t){G(h)}}}var b=function(d,e,f){Kg(function(){var h,k=md;k.postscribe||(k.postscribe=ec);h=k.postscribe;var l={done:e},m=F.createElement("div");m.style.display="none";m.style.visibility="hidden";F.body.appendChild(m);try{h(m,d,l)}catch(p){G(f)}})};var c=function(d){if(F.body){var e=
